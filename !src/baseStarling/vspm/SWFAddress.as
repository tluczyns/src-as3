...
package baseStarling.vspm {
    ...
    public class SWFAddress {
		...
		public static function setValueWithCurrentParameters(path: String): void {
			SWFAddress.setValueWithParameters(path, {}, false);
		}
		
		public static function refreshView(): void {
			ManagerSection.isForceRefresh = true;
			SWFAddress.setCurrentSwfAddressValueWithParameters({refresh: Math.floor(Math.random() * 1000000)});
		}			
