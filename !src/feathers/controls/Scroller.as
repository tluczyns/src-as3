	...
	public class Scroller extends FeathersControl
	{
		...
		protected function throwHorizontally(pixelsPerMS:Number):void
		{
			if(this._snapToPages)
			{
				...
				{
					targetHorizontalPageIndex = Math.round((snappedPageHorizontalScrollPosition - this._minHorizontalScrollPosition) / this.actualPageWidth); //TŁ dodane Math.round
				}
		...
		protected function throwVertically(pixelsPerMS:Number):void
		{
			if(this._snapToPages)
			{
				...
				{
					targetVerticalPageIndex = Math.round((snappedPageVerticalScrollPosition - this._minVerticalScrollPosition) / this.actualPageHeight); //TŁ dodane Math.round
				}
