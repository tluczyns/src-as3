package base.bitmapOutline {
	...
	public class BitmapDataUtil{
		...
		public static function getPointsMatchingColor(bmd:flash.display.BitmapData,color:uint):Array{
		...
		public static function getPointsMatchingColor32(bmd:flash.display.BitmapData,color:uint):Array{
			var points:Array=new Array();
			for(var i:uint=0;i<bmd.height;i++){
				for(var j:uint=0;j<bmd.width;j++){
		...
		public static function getNonTransparentPoints(bmd:flash.display.BitmapData,grab_every:uint=2,resize_percent:Number=1,offset:Point=null):Array{
