package base.mvc.section {
	...
	public class ViewSectionWithLoading extends ViewSection {
		...
		public function ViewSectionWithLoading(): void {}
		...
		protected function showAfterLoading(): void {
			DoOperations.playToFrame(this, this.totalFrames, this.startAfterShow, this);
		}
		...
		protected function finishRemovePreloader(): void {
			if (this.isHideShow == 0) this.hideComplete();
		...
		protected function hideAfterLoading(): void {
			DoOperations.playToFrame(this, 1, this.hideComplete, this);
		}
