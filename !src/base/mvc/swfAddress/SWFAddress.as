...
package base.mvc.swfAddress {
	...
	import base.mvc.section.LoaderXMLContentViewSection;
	import base.mvc.section.ViewSectionManager;
    ...
    public class SWFAddress {
        ...
        public static function setValue(value:String):void {
			...
			if ((LoaderXMLContentViewSection.dictIndToAliasIndSection) && (LoaderXMLContentViewSection.dictIndToAliasIndSection[path])) path = LoaderXMLContentViewSection.dictIndToAliasIndSection[path];
		...
		public static function setCurrentSwfAddressValueWithParameters(objParamsNewAndChanged: Object, isReplaceParams: Boolean = false): void {
			SWFAddress.setValueWithParameters(SWFAddress.getCurrentSwfAddress(), objParamsNewAndChanged, isReplaceParams);
		}
		
		public static function setPathWithParameters(path: String, objParamsNewAndChanged: Object, isReplaceParams: Boolean = false): void {
			SWFAddress.setValueWithParameters(SWFAddress.getPath(path), objParamsNewAndChanged, isReplaceParams);
		}	
		
		public static function setValueWithParameters(value: String, objParamsNewAndChanged: Object, isReplaceParams: Boolean = false): void {
			...
			if ((newValue == oldValue) && (ViewSectionManager.isForceRefresh)) 
				SWFAddress.dispatchEvent(new SWFAddressEvent(SWFAddressEvent.CHANGE));
			
		}
		
		public static function setPathWithCurrentParameters(path: String): void {
			SWFAddress.setPathWithParameters(path, false, {});
		}		
