...
package com.transmote.flar.source {
	...
	public class FLARCameraSource extends Sprite implements IFLARSource {
		...
		public var camera:Camera; //TŁ: was private
		...
		private var sampleBmpFilter: BitmapFilter;
		...
		public function init (
			...
			//TŁ - kontrastowa bitmapa
			var mc: Number = 2;
			var co: Number = -128;
			this.sampleBmpFilter = new ColorMatrixFilter([
				mc,	0,	0, 	0, co,
				0,	mc,	0, 	0, co,
				0,	0,	mc,	0, co,
				0,  0, 	0, 	1,  0
...
//			this.addChild(this.sampleBitmap);
		...
		public function update () :void {
			...
			if (this.sampleBmpFilter != null) this.sampleBmpData.applyFilter(this.sampleBmpData, this.sampleBmpData.rect, this.sampleBmpData.rect.topLeft, this.sampleBmpFilter);
		}
